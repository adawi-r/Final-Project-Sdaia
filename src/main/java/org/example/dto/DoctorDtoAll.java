...
public class DoctorDtoAll {
    ...
    public DoctorDtoAll(int doctor_id, String doctor_name, String doctor_specialty, String doctor_email, String doctor_password, String doctor_phone) {
    ...
    public DoctorDtoAll(int doctor_id, String doctor_name, String doctor_specialty) {
        this.doctor_id = doctor_id;
        this.doctor_name = doctor_name;
        this.doctor_specialty = doctor_specialty;
    }
